    ...
    return (
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            ...
            <div className="rounded-md shadow-sm -space-y-px">
                ...
                <div>
                    <label for="name" className="sr-only">Registration Number</label>
                ...
                <div>
                    <label for="password-confirm" className="sr-only">Confirm password</label>
            ...
            <div>
                <Link to="/">
                    <button type="button" className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
